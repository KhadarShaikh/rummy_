...
public class GenerateSMS {
	...
	public static String generateOTP(UserAccount userAccount) {
		String response = null;
		// Your apikey key
		String apiKey = "YourApiKey";
		// OR
		String userId = userAccount.getUsername();
		...
		String msg = "Your Rummy OTP Code is $otp$";
