resourceApp.controller('resourcesearchCtrl',['$scope','$rootScope','RAService','$state',function($scope,$rootScope,RAService,$state){
	  ...
	  var totalExperience =$rootScope.totalExperience;
	 	RAService.searchrequirement(skills,jobCategory,jobLocation,totalExperience).then(function(data){
	 		debugger;
