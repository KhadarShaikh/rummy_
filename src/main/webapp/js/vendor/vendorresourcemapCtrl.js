resourceApp.controller('vendorresourcemapCtrl',["$scope","$state","$stateParams","RAService",function($scope,$state,$stateParams,RAService){
	...
	$scope.submitdata = function(){
		...
		RAService.mappingresource($scope.filter).then(function(data){
			$scope.resourcemap123 = data.result;
